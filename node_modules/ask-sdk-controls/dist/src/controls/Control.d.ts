...
export interface ControlState {
    /**
     * The public value of this control.
     *
     * The value is not necessarily valid or confirmed. Consumers should
     * call `control.isReady()` to determine if the value is ready for use.
     *
     * Usage:
     * - Controls should ensure that their `value` is up-to-date after every call
     * to `control.handle()`. Parent controls should gather the values from
     * their children and make them available as a POJO in `.state.value`.
     */
    value?: any;
}
