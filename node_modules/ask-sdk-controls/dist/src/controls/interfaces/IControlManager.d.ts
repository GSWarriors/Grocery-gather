...
/**
 * Defines skill functionality built with Controls
 *
...
export interface IControlManager {
     ...
     * @return A Control that is either a single @see Control or a @see ContainerControl that is the root of a tree.
     */
    ...
    /**
     * Builds the response.
     * The response should be built directly on the responseBuilder parameter.
     */
    render(result: IControlResult, input: IControlInput, responseBuilder: ResponseBuilder): void | Promise<void>;
    /**
     * Custom handling of a internal error before the skill exits and closes the user session
     */
