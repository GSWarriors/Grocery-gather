...
/**
 * Defines a builder to prepare a ControlResult.
 *
 * This is the minimal definition required by the Runtime (ControlHandler)
 * See `ControlResultBuilder` for the actual class used by Control implementations.
 */
...
//# sourceMappingURL=IControlResultBuilder.d.ts.map